<%-- 
    Document   : footer
    Created on : Jul 6, 2025, 10:52:34 AM
    Author     : an0other
--%>
                            ...
                            <div class="footer-menu">
                                ...
                                <div class="social-links">
                                    <ul class="d-flex list-unstyled">
                                        <li>
                                            <a href="https://www.facebook.com/iamjustan0other/" target="_blank">
                                                <svg class="facebook">
                            ...
                            <div class="footer-menu text-uppercase">
                                ...
                                <ul class="menu-list list-unstyled text-uppercase">
                                    <li class="menu-item pb-2">
                                        <a href="MainController?action=get4thProduct">Home</a>
                                    </li>
                                    <li class="menu-item pb-2">
                                        <a href="#">About</a>
                                    </li>
                                    <li class="menu-item pb-2">
                                        <a href="MainController?action=searchProduct">Shop</a>
                                    </li>
                                    <li class="menu-item pb-2">
                                        <a href="#">Contact</a>
                                    </li>
